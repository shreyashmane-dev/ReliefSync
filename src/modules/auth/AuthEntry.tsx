...
export const AuthEntry = () => {
  ...
  return (
    <div style={{ fontFamily: 'Inter, sans-serif', background: '#f8f9fb', minHeight: '100vh', display: 'flex', flexDirection: 'column', color: '#191c1e' }}>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: isMobile ? '40px 16px' : '64px 32px', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: isMobile ? 520 : 800, height: isMobile ? 520 : 800, background: 'radial-gradient(circle, rgba(0,82,204,0.05) 0%, transparent 70%)', borderRadius: '50%', pointerEvents: 'none' }} />

        <div style={{ width: '100%', maxWidth: 960, position: 'relative', zIndex: 1 }}>
          <div style={{ textAlign: 'center', marginBottom: isMobile ? 36 : 56 }}>
            <h1 style={{ fontSize: isMobile ? 34 : 52, fontWeight: 800, letterSpacing: '-1.2px', margin: '0 0 16px' }}>Access Infrastructure</h1>
            <p style={{ fontSize: isMobile ? 16 : 18, color: '#737685', margin: 0, maxWidth: 560, marginLeft: 'auto', marginRight: 'auto', lineHeight: 1.6 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: 20 }}>
            <div style={{ background: 'rgba(255,255,255,0.6)', backdropFilter: 'blur(16px)', border: '1px solid rgba(255,255,255,0.6)', borderRadius: 24, padding: isMobile ? 24 : 40, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', boxShadow: '0 20px 48px rgba(0,82,204,0.06)' }}>
              <div>
                ...
                <h2 style={{ fontSize: isMobile ? 24 : 28, fontWeight: 800, margin: '0 0 12px', letterSpacing: '-0.3px' }}>User Access</h2>
                <p style={{ fontSize: 15, color: '#737685', margin: '0 0 28px', lineHeight: 1.65 }}>
            ...
            <div style={{ background: 'rgba(255,255,255,0.6)', backdropFilter: 'blur(16px)', border: '1px solid rgba(255,255,255,0.6)', borderRadius: 24, padding: isMobile ? 24 : 40, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', boxShadow: '0 20px 48px rgba(0,82,204,0.06)', position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                <h2 style={{ fontSize: isMobile ? 24 : 28, fontWeight: 800, margin: '0 0 12px', letterSpacing: '-0.3px' }}>Admin Access</h2>
                <p style={{ fontSize: 15, color: '#737685', margin: '0 0 28px', lineHeight: 1.65 }}>
                ...
                <p style={{ fontSize: 12, color: '#737685', margin: '0 0 28px', display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <div style={{ textAlign: 'center', marginTop: 24, display: 'flex', justifyContent: 'center', gap: isMobile ? 16 : 32, flexWrap: 'wrap' }}>
            {['New Organization?', 'API Access', 'System Status'].map((item) => (
      ...
      <footer style={{ background: '#fff', borderTop: '1px solid #f1f5f9', padding: isMobile ? '24px 16px' : '24px 32px' }}>
